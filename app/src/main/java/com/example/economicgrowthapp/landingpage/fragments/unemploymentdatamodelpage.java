...
public class unemploymentdatamodelpage extends AppCompatActivity {

    private TextView textViewIndicatorName, textViewPeriodicity, textViewAggregationMethod,
            textViewTopic, textViewLongDefinition, textViewStatisticalConcept, textViewLimitations, accounttext, indicator_text;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        indicator_text = findViewById(R.id.indicator_text);

        indicator_text.setText("UNEMPLOYMENT RATE");

        toolbar.setTitle("UNEMPLOYMENT RATE");
...
// Inside your second activity
        ...
        if (extras != null) {
            String receivedText = extras.getString("unemploymentrate");
        ...
        new unemploymentdatamodelpage.FetchDataTaskSummary().execute();
        new FetchUnemploymentRateDataTask().execute();
            ...
            if (jsonObject != null) {
                try {
                    ...
                    for (int i = 0; i < dataArray.length(); i++) {
                        ...
                        if ("SL.UEM.TOTL.NE.ZS".equals(code)) { // Replace with the desired Code value
    ...
    private class FetchUnemploymentRateDataTask extends AsyncTask<Void, Void, JSONObject> {
        ...
        protected void onPostExecute(JSONObject result) {
            if (result != null) {
                createlinegraphforUnemploymentRate(result);
            }
        }
    }
